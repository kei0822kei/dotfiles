...
""" to use deoplete
let g:python_host_prog = '~/.pyenv/versions/anaconda3-5.3.1/envs/nvim-2/bin/python'
let g:python3_host_prog = '~/.pyenv/versions/anaconda3-5.3.1/envs/nvim-3/bin/python'
